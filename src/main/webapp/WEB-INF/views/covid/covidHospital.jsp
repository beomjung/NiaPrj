...
<%@ page import="kopo.poly.dto.CovidHospitalDTO" %>
<%@ page import="kopo.poly.dto.CovidClinic" %>
...
<%
    List<CovidHospitalDTO> hList = (List<CovidHospitalDTO>) request.getAttribute("cList");
%>
...
<head>
    ...
    <script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=48d1705d25c702323d5ab44bb8a16521&libraries=services,clusterer,drawing"></script>
...
<div class="wrapper">
            ...
            <div class="row justify-content-center">
                <div class="col-xl-6">
                    <div class="breadcrumb_content">
                        <h1 class="breadcrumb_title">코로나 병원을 조회합니다.</h1>
                        <p></p>
    ...
    <section class="our-faq">
        <div class="container">
            <h3 class="mt0 mb35" style="text-align: center;">코로나 병원 조회</h3>

            <div class="row">
                <div class="col-sm-12 col-lg-6 offset-lg-3" style="margin-bottom: 30px;">
                    <form action="/covid/hospital" method="get" name="form" id="form">

                        <div class="input-group">
                            <select class="form-control" name="sidoNm" style="display: inline">
                ...
                <div class="col-lg-8 offset-lg-2">
                    <h3 class="mt0 mb35" font-family: jua;> 조회한 코로나 병원</h3>
                    <div class="row mt50">
                        <div class="col-lg-12">
                        ...
                        <div class="table-responsive invoice_table_list">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <th class="fw500 color-black22" scope="col">전화번호</th>
                                    <th class="fw500 color-black22 border-right" scope="col">운영일자</th>
                                </tr>
                                </thead>
                                <tbody>

                                <%
                                    for (CovidHospitalDTO hospital: hList) {
                                %>
                                <tr>
                                    <th class="body-color border-left" scope="row"><%=hospital.getYadmNm()%></th>
                                    <td class="body-color"><%=hospital.getSgguNm()%></td>
                                    <td class="body-color"><%=hospital.getTelno()%></td>
                                    <td class="color-black22 border-right"><%=hospital.getAdtFrDd()%></td>
                                </tr>
...
<script>
    ...
    ps.keywordSearch('${result.yadmNm}', placesSearchCB);
    </c:forEach>
